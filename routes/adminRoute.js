...
admin_route.post('/add-product',multer.uploads.array('pImage',3), productController.addAddProducts);

admin_route.get('/edit-product', productController.showEditProduct);

admin_route.post('/edit-product',multer.uploads.array('pImage',3), productController.editProduct);
